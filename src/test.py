...
class TestProfile( unittest.TestCase ):
    ...
    def test_adding_long_distance_mobile_call( self ):
        ...
        profile.add_call( call )
        profile.add_call( call )
        self.assertEqual( profile.get_long_distance_mobile_call_usage(), 2 )
    ...
    def test_adding_local_landline_call( self ):
        ...
        profile.add_call( call )
        profile.add_call( call )
        self.assertEqual( profile.get_local_landline_call_usage(), 2 )
    ...
    def test_adding_local_mobile_call( self ):
        ...
        profile.add_call( call )
        profile.add_call( call )
        self.assertEqual( profile.get_local_mobile_call_usage(), 2 )
    ...
    def test_adding_internet( self ):
        ...
        profile.add_internet( 1 )
        self.assertEqual( profile.get_internet_usage(), 2 )
